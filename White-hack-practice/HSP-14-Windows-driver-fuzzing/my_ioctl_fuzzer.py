...
for device_name in device_list:
    ...
    device_file = u"\\\\.\\GLOBALROOT\\Device\\%s" % device_name.split("\\")[::-1][0]
    ...
    if driver_handle > 0:
        ...
        print "driver_handle = %d" % driver_handle
...
while 1:
    ...
    print( "[*] Test case finished. %d bytes returned.\n" % bytes_returned.value )
