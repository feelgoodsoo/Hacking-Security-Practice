...
class pydbg:
        ...
        if kernel32.WaitForDebugEvent(byref(dbg), 100):
            ...
            # an exception was caught.
                ...
                # unhandled exception.
                    ...
                    # continue_status = self.exception_handler_access_violation()  # kssohn-20220420
                    continue_status = DBG_EXCEPTION_NOT_HANDLED
                    # continue_status = DBG_CONTINUE # kssohn-20220420
    ...
    def process_snapshot (self, mem_only=False):
        ...
        while cursor < 0xFFFFFFFF:
            ...
            if mbi.State != MEM_COMMIT: # kssohn-20220420
            # kssohn-20220420 if mbi.State != MEM_COMMIT or mbi.Type == MEM_IMAGE:
                save_block = False
